...
class HistogramWidget(QWidget):
    ...
    def __init__(self, viewer):
        ...
        self.graphWidget.plot(x[:-1], y, range=(0., 1.), density = True)
        ...
        self.log_intensity_slider.setMinimum(int(self.minimum*10))
        self.log_intensity_slider.setMaximum(int(self.maximum*10))
        self.log_intensity_slider.setValue(10)
    ...
    def update_intensity(self):
        ...
        self.brain.intensity = float(value)/10
